...
class ReactivePrimitive {
  ...
  set(value, ...noUpdate) {
    if (value !== __classPrivateFieldGet(this, _value)) {
      ...
      ].filter((cb) => !noUpdate.includes(cb)).forEach((cb) => cb(value));
    }
    return this;
  }
  set value(value) {
  ...
  static from(updater, ...refs) {
    ...
    refs.forEach((ref) =>
      ref.bind(() => queueMicrotask(() => newRef.value = currentValue()), true)
    );
    return newRef;
  }
  pipe(callback) {
...
var __classPrivateFieldSet1 = this && this.__classPrivateFieldSet ||
  function (receiver, privateMap, value) {
    if (!privateMap.has(receiver)) {
      throw new TypeError("attempted to set private field on non-instance");
    }
...
var __classPrivateFieldGet1 = this && this.__classPrivateFieldGet ||
  function (receiver, privateMap) {
    if (!privateMap.has(receiver)) {
      throw new TypeError("attempted to get private field on non-instance");
    }
...
class Ref {
  ...
  then(callbackFn) {
    __classPrivateFieldSet1(
      this,
      _promise,
      __classPrivateFieldGet1(this, _promise).then(callbackFn),
    );
    return this;
  }
  catch(callbackFn) {
...
function register(componentConstructor, noHash = true) {
  ...
  const name = `${givenName ? pascalToKebab(givenName) : "anonymous"}${
...
function attribute(attributes, element) {
  for (const [key, value] of attributes) {
    doOrBind(
      ...
      key,
      value,
      (value1) => element.setAttribute(key, String(value1)),
    );
  }
}
...
function destinyRef(value, element) {
  if (!(value instanceof Ref)) {
    throw new TypeError(
      `Attribute value for destiny:ref must be a Ref, but it was [${
        isObject(value)
...
function reactiveObject1(input, parent) {
  ...
  Object.seal(
    Object.defineProperties(
      ...
      Object.fromEntries(
        Object.entries(
          Object.assign(prototypeChain.shift(), ...prototypeChain, {
            [reactiveObjectFlag]: {
              writable: false,
              enumerable: false,
              value: true,
          ...
          typeof value !== "function" && configurable
...
var __classPrivateFieldSet2 = this && this.__classPrivateFieldSet ||
  function (receiver, privateMap, value) {
    if (!privateMap.has(receiver)) {
      throw new TypeError("attempted to set private field on non-instance");
    }
...
var __classPrivateFieldGet2 = this && this.__classPrivateFieldGet ||
  function (receiver, privateMap) {
    if (!privateMap.has(receiver)) {
      throw new TypeError("attempted to get private field on non-instance");
    }
...
class ReactiveArray1 {
  constructor(...input1) {
    ...
    __classPrivateFieldSet2(
      this,
      _value1,
      makeNonPrimitiveItemsReactive1(input1, this),
    );
    __classPrivateFieldSet2(
      this,
      _length,
      ReactivePrimitive.from(
    ...
    __classPrivateFieldSet2(
      this,
      _indices,
      input1.map((_, i) => new ReactivePrimitive(i)),
    );
  ...
  *[
  ...
  get(index) {
    const i = index < 0
      ? __classPrivateFieldGet2(this, _value1).length + index
      : index;
  ...
  concat(...items) {
    ...
    for (const [i, item] of items.entries()) {
      if (item instanceof ReactiveArray1) {
        item.bind((index, deleteCount, ...values) =>
          newArr.splice(currentOffset(i, index), deleteCount, ...values)
        );
  ...
  copyWithin(
    target,
    start = 0,
    end = __classPrivateFieldGet2(this, _value1).length,
  ) {
    ...
    this.splice(
      target,
      deleteCount,
      ...__classPrivateFieldGet2(this, _value1).slice(
        start,
        deleteCount + start,
      ),
    );
  ...
  splice(
    start,
    deleteCount = __classPrivateFieldGet2(this, _value1).length - start,
    ...items
  ) {
    if (start > __classPrivateFieldGet2(this, _value1).length) {
      throw new RangeError(
        "Out of bounds assignment. Sparse arrays are not allowed. Consider using .push() instead.",
      );
    }
    this._adjustIndices(start, deleteCount, items);
    const reactiveItems = makeNonPrimitiveItemsReactive1(items, this);
    const deletedItems = __classPrivateFieldGet2(this, _value1).splice(
      start,
      deleteCount,
      ...reactiveItems,
    );
  ...
  _adjustIndices(start, deleteCount, items) {
    ...
    if (shiftedBy) {
      for (
        ...
        i < __classPrivateFieldGet2(this, _indices).length;
        i++
      ) {
        __classPrivateFieldGet2(this, _indices)[i].value += shiftedBy;
      }
    }
    const removedIndices = __classPrivateFieldGet2(this, _indices).splice(
      start,
      deleteCount,
  ...
  filter(callback) {
    ...
    this.bind(() =>
      newArr.setValue(__classPrivateFieldGet2(this, _value1).filter(callback))
    );
    return newArr;
  }
  flat(depth = 1) {
    throw new NotImplementedError(
      "See https://github.com/0kku/destiny/issues/1",
    );
  }
  flatMap(callback) {
    throw new NotImplementedError(
  ...
  map(callback) {
    const cb = (v, i) =>
      callback(v, __classPrivateFieldGet2(this, _indices)[i], this);
    const newArr = new ReactiveArray1(
      ...__classPrivateFieldGet2(this, _value1).map(cb),
    );
    __classPrivateFieldGet2(this, _callbacks1).add((
      index,
      deleteCount,
      ...values
    ) =>
  ...
  slice(start = 0, end = __classPrivateFieldGet2(this, _value1).length - 1) {
    const newArr = new ReactiveArray1(
      ...__classPrivateFieldGet2(this, _value1).slice(start, end),
    );
    this.bind((index, deleteCount, ...values) =>
      newArr.splice(
        index - start,
        deleteCount,
  ...
  indexOf(...args) {
    ...
    return index === -1
      ...
      : __classPrivateFieldGet2(this, _indices)[index];
  }
  lastIndexOf(...args) {
  ...
  join(...args) {
    return this.pipe(() =>
      __classPrivateFieldGet2(this, _value1).join(...args)
    );
  }
  every(...args) {
    return this.pipe(() =>
      __classPrivateFieldGet2(this, _value1).every(...args)
    );
  }
  some(...args) {
    return this.pipe(() =>
      __classPrivateFieldGet2(this, _value1).some(...args)
    );
  }
  exclusiveSome(cb) {
    return this.pipe(() => {
  ...
  forEach(...args) {
    ...
    this.bind((_index, _deleteCount, ...addedItems) =>
      addedItems.forEach(...args)
    );
  }
  reduce(...args) {
    return this.pipe(() =>
      __classPrivateFieldGet2(this, _value1).reduce(...args)
    );
  }
  reduceRight(...args) {
    return this.pipe(() =>
      __classPrivateFieldGet2(this, _value1).reduceRight(...args)
    );
  }
  find(...args) {
  ...
  entries() {
    const array = new ReactiveArray1(
      ...__classPrivateFieldGet2(this, _value1).entries(),
    );
  ...
  keys() {
    const array = new ReactiveArray1(
      ...__classPrivateFieldGet2(this, _value1).keys(),
    );
    this.bind((index, deleteCount, ...addedItems) => {
  ...
  values() {
    const array = new ReactiveArray1(
      ...__classPrivateFieldGet2(this, _value1).values(),
    );
    this.bind((index, deleteCount, ...addedItems) => {
  ...
  includes(...args) {
    return this.pipe(() =>
      __classPrivateFieldGet2(this, _value1).includes(...args)
    );
  }
}
...
function generateFn(templ, args) {
  const functionBody = templ.reduce((acc, v, i) =>
...
var __classPrivateFieldSet3 = this && this.__classPrivateFieldSet ||
  function (receiver, privateMap, value) {
    if (!privateMap.has(receiver)) {
      throw new TypeError("attempted to set private field on non-instance");
    }
...
var __classPrivateFieldGet3 = this && this.__classPrivateFieldGet ||
  function (receiver, privateMap) {
    if (!privateMap.has(receiver)) {
      throw new TypeError("attempted to get private field on non-instance");
    }
...
class TemplateResult extends Renderable {
  ...
  get content() {
    const content = __classPrivateFieldGet3(this, _template).content.cloneNode(
      true,
    );
...
function parser(strings, props1, parser1) {
  const template1 = getFromCache(
    strings,
    () => createTemplate1(strings, props1, parser1),
    props1,
  );
    ...
    if (!(get && set)) {
      ...
      descriptor.set = (value) => {
        if (ref instanceof ReactivePrimitive) {
          ...
          throw new TypeError(
            `Illegal assignment to reactive object field ${key}`,
          );
        }
      };
    }
...
function makeNonPrimitiveItemsReactive(items, parent) {
  return items.map((v) => {
    return isReactive(v) || !isObject(v) || isSpecialCaseObject1(v)
      ? v
      : reactive2(v, {
        parent: parent,
      });
...
function parseAttributeName(input1) {
  const { namespace = "attribute", attributeNameRaw } =
    /(?:(?<namespace>[a-z]+):)?(?<attributeNameRaw>.+)/.exec(input1)?.groups ??
      {};
  ...
  if (val.length === 1 && !val[0].groups.start && !val[0].groups.after) {
    ...
    const resolvedValue = val.reduce((acc, value) => {
      ...
      if (item instanceof ReactivePrimitive) {
        ...
        acc.trailings[acc.trailings.length - 1] += String(item) +
          (value.groups.after ?? "");
      }
      return acc;
    }, {
    ...
    if (resolvedValue.items.length) {
      attrVal = ReactivePrimitive.from(
        (...args) =>
          resolvedValue.trailings.reduce((a, v, i) => a + String(args[i]) + v),
        ...resolvedValue.items,
      );
    } else {
...
const stringifyValue = (input1) =>
  shouldBeRendered(input1) ? String(input1) : "";
...
var __classPrivateFieldSet4 = this && this.__classPrivateFieldSet ||
  function (receiver, privateMap, value) {
    if (!privateMap.has(receiver)) {
      throw new TypeError("attempted to set private field on non-instance");
    }
...
var __classPrivateFieldGet4 = this && this.__classPrivateFieldGet ||
  function (receiver, privateMap) {
    if (!privateMap.has(receiver)) {
      throw new TypeError("attempted to get private field on non-instance");
    }
...
class Slot1 {
  constructor(placeholderNode, content) {
    ...
    _startAnchor.set(
      this,
      new Comment(`<DestinySlot(${__classPrivateFieldGet4(this, _id)})>`),
    );
    _endAnchor.set(
      this,
      new Comment(`</DestinySlot(${__classPrivateFieldGet4(this, _id)})>`),
    ...
    placeholderNode.replaceWith(
      __classPrivateFieldGet4(this, _startAnchor),
      placeholderNode,
      __classPrivateFieldGet4(this, _endAnchor),
    );
    if (content) {
      this.update(content);
    }
  ...
  replaceItem(whatToReplace, ...nodes) {
    const location = __classPrivateFieldGet4(this, _nodes).indexOf(
      whatToReplace,
    );
    if (location < 0) throw new Error("Can't replace an item that isn't here.");
    const newNodes = nodes.flatMap((v) =>
      typeof v === "string" ? new Text(v) : v instanceof DocumentFragment
        ? [
          ...v.childNodes,
        ]
        : v
  ...
  async _disposeNodes(nodesToDisposeOf) {
    await Promise.all(
      nodesToDisposeOf.map((node) => deferredElements.get(node)?.(node)),
    );
  ...
  async _disposeCurrentNodes() {
    await this._disposeNodes(
      __classPrivateFieldGet4(this, _nodes).splice(
        0,
        __classPrivateFieldGet4(this, _nodes).length,
      ),
    );
  }
  async remove() {
...
_id = new WeakMap(),
  _startAnchor = new WeakMap(),
  _endAnchor = new WeakMap(),
  _nodes = new WeakMap();
var __classPrivateFieldGet5 = this && this.__classPrivateFieldGet ||
  function (receiver, privateMap) {
    if (!privateMap.has(receiver)) {
      throw new TypeError("attempted to get private field on non-instance");
    }
...
var __classPrivateFieldSet5 = this && this.__classPrivateFieldSet ||
  function (receiver, privateMap, value) {
    if (!privateMap.has(receiver)) {
      throw new TypeError("attempted to set private field on non-instance");
    }
...
class SlotArray {
  constructor(placeholderNode1, source) {
    ...
    placeholderNode1.replaceWith(
      __classPrivateFieldGet5(this, _startAnchor1),
      __classPrivateFieldGet5(this, _endAnchor1),
    );
  ...
  _insertToDom(index, ...fragments) {
    fragments.forEach((fragment, i) => {
      ...
      if (
        !__classPrivateFieldGet5(this, _domArray).length ||
        where > __classPrivateFieldGet5(this, _domArray).length - 1
      ) {
        __classPrivateFieldGet5(this, _endAnchor1).before(slotPlaceholder);
      } else {
        __classPrivateFieldGet5(this, _domArray)[where].insertBeforeThis(
          slotPlaceholder,
        );
      }
      __classPrivateFieldGet5(this, _domArray).splice(
        where,
        0,
        new Slot2(slotPlaceholder, fragment),
      );
    });
  }
...
_startAnchor1 = new WeakMap(),
  _endAnchor1 = new WeakMap(),
  _source = new WeakMap(),
  ...
  for (const [i, fragment] of strings.entries()) {
    ...
    if (string.endsWith("<")) {
      ...
      if (isDestinyElement3(prop1)) {
        ...
        string += `${
          register(DestinyFallback1, false)
        } prop:for="__internal_${i}_" data-capture-props="true"${fragment}`;
      } else {
...
function isDestinyElement1(input2) {
  return Boolean(input2) && typeof input2 === "function" &&
    Object.prototype.isPrototypeOf.call(DestinyElement2, input2);
}
